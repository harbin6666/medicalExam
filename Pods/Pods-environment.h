...
// AFSQLManager
#define COCOAPODS_POD_AVAILABLE_AFSQLManager
#define COCOAPODS_VERSION_MAJOR_AFSQLManager 1
#define COCOAPODS_VERSION_MINOR_AFSQLManager 0
#define COCOAPODS_VERSION_PATCH_AFSQLManager 2
